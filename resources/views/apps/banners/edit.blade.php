                                ...
                                <form action="{{ route('banners.update', $banners->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text"
                                                class="form-control" name="big_title" value="{{ $banners->big_title }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text"
                                                class="form-control" name="small_title" value="{{ $banners->small_title }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text"
                                                class="form-control" name="big_title_en" value="{{ $banners->big_title_en }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text"
                                                class="form-control" name="small_title_en" value="{{ $banners->small_title_en }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">

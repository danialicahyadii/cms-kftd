                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('corporate-governances.update', $corporateGovernances->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="summernote-simple" name="content">{{ $corporateGovernances->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">File (Current File: <a href="{{ $corporateGovernances->file_link }}" target="_blank">View</a>)</label>
                                        <div class="col-sm-12 col-md-7">

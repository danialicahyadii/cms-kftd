                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('branch.update', $branch->soffice) }}" method="POST"
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sales Office
                                            Desc</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="soffice_desc"
                                                value="{{ $branch->soffice_desc }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            <div id="image-preview" class="image-preview"
                                                style="background-image: url('https://kftd.co.id/assets/img/branch/{{ str_replace(' ', '%20', $branch->image) }}');
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Branch
                                            Manager</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="branch_manager"
                                                value="{{ $branch->branch_manager }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3">Longitude dan
                                            Latitude</label>
                                        <div class="col-sm-12 col-md-3">
                                            <input type="text" name="longitude" value="{{ $branch->longitude }}"
                                                class="form-control" placeholder="Longitude" required>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <input type="text" name="latitude" value="{{ $branch->latitude }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="gmaps_link"
                                                value="{{ $branch->gmaps_link }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
